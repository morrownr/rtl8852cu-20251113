...
#define REGULATION_CHPLAN_VERSION_8852C 68
#define REGULATION_COUNTRY_VERSION_8852C 55
...
static const struct country_domain_mapping cdmap_8852c[] = {
    ...
    {0x11, 0x00, {'B', 'O'}, TPO_NA, 0x0f, 0, 0x00000000, 0x00000003, 0x01, 0}, /* 0001 */
    {0x62, 0x05, {'B', 'R'}, TPO_NA, 0x1f, 0, 0x00000000, 0x00000003, 0x01, 0}, /* 0002 */
    {0x76, 0x01, {'C', 'L'}, TPO_CHILE, 0x1f, 0, 0x00000000, 0x00000003, 0x01, 0}, /* 0003 */
    ...
    {0x5e, 0x00, {'M', 'Z'}, TPO_NA, 0x1f, 0, 0x00000000, 0x00000003, 0x00, 0}, /* 0069 */
    {0x5e, 0x00, {'N', 'A'}, TPO_NA, 0x1f, 0, 0x00000000, 0x00000003, 0x00, 1}, /* 0070 */
    {0x75, 0x00, {'N', 'G'}, TPO_NA, 0x1f, 0, 0x00000000, 0x00000003, 0x00, 0}, /* 0071 */
    {0x5e, 0x00, {'O', 'M'}, TPO_NA, 0x1f, 0, 0x00000000, 0x00000003, 0x00, 0}, /* 0072 */
    ...
    {0x4b, 0x08, {'K', 'R'}, TPO_NA, 0x0f, 0, 0x00000001, 0x00000003, 0x05, 0}, /* 0092 */
    ...
    {0x10, 0x07, {'C', 'A'}, TPO_NA, 0x1f, 0, 0x00000000, 0x00000003, 0x03, 0}, /* 0104 */
    ...
    {0x76, 0x05, {'A', 'G'}, TPO_NA, 0x1f, 0, 0x00000000, 0x00000003, 0x01, 0}, /* 0117 */
    ...
    {0x5e, 0x06, {'K', 'M'}, TPO_NA, 0x1f, 0, 0x00000000, 0x00000003, 0x01, 1}, /* 0142 */
    ...
    {0x76, 0x05, {'G', 'U'}, TPO_NA, 0x1f, 0, 0x00000000, 0x00000003, 0x01, 1}, /* 0165 */
    ...
    {0x5e, 0x00, {'L', 'R'}, TPO_NA, 0x0f, 0, 0x00000000, 0x00000003, 0x00, 1}, /* 0178 */
    ...
    {0x76, 0x05, {'M', 'H'}, TPO_NA, 0x1f, 0, 0x00000000, 0x00000003, 0x01, 1}, /* 0185 */
    ...
    {0x76, 0x05, {'F', 'M'}, TPO_NA, 0x1f, 0, 0x00000000, 0x00000003, 0x01, 1}, /* 0190 */
    ...
    {0x76, 0x05, {'M', 'P'}, TPO_NA, 0x1f, 0, 0x00000000, 0x00000003, 0x01, 1}, /* 0200 */
    {0x76, 0x05, {'P', 'W'}, TPO_NA, 0x1f, 0, 0x00000000, 0x00000003, 0x01, 1}, /* 0201 */
    ...
    {0x76, 0x05, {'M', 'F'}, TPO_NA, 0x1f, 0, 0x00000000, 0x00000003, 0x01, 1}, /* 0207 */
    {0x76, 0x05, {'S', 'X'}, TPO_NA, 0x1f, 0, 0x00000000, 0x00000003, 0x01, 1}, /* 0208 */
    ...
    {0x5e, 0x06, {'T', 'Z'}, TPO_NA, 0x0f, 0, 0x00000000, 0x00000003, 0x05, 0}, /* 0223 */
    ...
    {0x76, 0x05, {'V', 'I'}, TPO_NA, 0x1f, 0, 0x00000000, 0x00000003, 0x01, 1}, /* 0231 */
    ...
    {0x5e, 0x00, {'C', 'U'}, TPO_NA, 0x01, 0, 0x00000000, 0x00000003, 0x00, 0}, /* 0237 */
...
{
	PHL_GET_RG_FUNC_CERT_BY_COUNTRY(country, cdmap_8852c, rg_cert);
}
