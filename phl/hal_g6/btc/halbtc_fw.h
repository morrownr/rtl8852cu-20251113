...
enum btf_set_report_en {
	...
	RPT_EN_BT_TX_PWR_LVL = BIT8,
	RPT_EN_FW_STEP_INFO = BIT9,
	RPT_EN_FW_TEST_INFO = BIT10,
	RPT_EN_ALL = 0x3ff
};
...
void hal_btc_notify_hal_pwr_req(struct btc_t *btc, bool pwr_req, bool leave_immediately);
