...
#define CONFIG_80211AX_HE
		...
		#define CONFIG_80211AC_VHT
	#endif
	/* Full support for 6G band from kernel version 5.8 */
...
#define CONFIG_HW_RTS
	...
	/* #define CONFIG_DBCC_SUPPORT */
		...
		/*#define CONFIG_FW_DBCC_OFLD_SUPPORT*/
		#define RTW_WKARD_NOT_DO_DBCC_DIS_IN_DRV_STOP
		/*#define CONFIG_DBCC_P2P_BG_LISTEN*/
		/*#define CONFIG_DBCC_P2P_BG_LISTEN_SIM*/
	#endif
#endif
